        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="pl-8 pr-3 py-1.5 text-sm border border-gray-200 rounded-lg outline-none focus:border-orange-400 focus:ring-1 focus:ring-orange-200 bg-white w-40 transition-all"
            />
          </div>
          {/* Month Picker */}
